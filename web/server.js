  ...
  res.send(`
    ...
    <body>
      ...
      <script>
        ...
        async function checkImageExists(_date) {
          // Removed showing existing image message since alert is used for upload feedback
        }
...
app.post("/", upload.single("image"), async (req, res) => {
  ...
  if (fs.existsSync(outputPath)) {
    return res
      .status(400)
      .send("An image already exists for this date. Upload rejected.");
  }
